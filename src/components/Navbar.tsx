    ...
    return (
        <div className='flex flex-col md:flex-row md:justify-start justify-center items-center py-2 shadow-md'>
            ...
            <div ref={cartRef} className="w-72 h-full sideCart fixed top-0 right-0 z-50 bg-pink-100 px-8 py-10 transform transition-transform translate-x-full">
                ...
                <button className='flex mx-auto mt-16 text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded text-lg'><BsFillBagCheckFill className='mx-1'/> Checkout</button>
            </div>
        </div>
    )
}
