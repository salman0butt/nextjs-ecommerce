...
const Product: React.FC = () => {
  ...
  const checkServiceability = async () => {
    ...
    let pinJson: PinResponse = await pins.json();
  ...
  const handleChangePin = (e: ChangeEvent<HTMLInputElement>): void  => {
      ...
      <section className="text-gray-600 body-font overflow-hidden">
        <div className="container px-5 py-16 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto object-cover px-24 object-top rounded" src="https://m.media-amazon.com/images/I/71vZFqWN7VL._AC_UX679_.jpg" />
              <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <div className="flex">
                  ...
                  <button className="flex mx-2 md:ml-8 text-white bg-pink-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-pink-600 rounded">Buy Now!</button>
                  <button className="flex mx-2 md:ml-4 text-white bg-pink-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-pink-600 rounded">Add to Cart</button>
                ...
                <div className="pin mt-6 flex space-x-2">
                  <input onChange={handleChangePin} className='px-2 border-2 border-gray-400 rounded-md' type="text"/>
